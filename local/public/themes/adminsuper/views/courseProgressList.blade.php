	...
	<div class="card card-custom">
		<div class="card-header">
			<div class="card-title">
				...
				<h3 class="card-label">Course Progrss List</h3>
			</div>
		...
		<div class="card-body">
			...
			<!--begin: Datatable-->
			<!--begin: Datatable-->
			<table class="table table-bordered table-hover table-checkable" id="kt_datatable_userprogressList" style="margin-top: 13px !important">
				<thead>
					<tr>
						<th>Record ID</th>
						<th>S#</th>
