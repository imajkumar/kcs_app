                    ...
                    <div class="d-flex flex-column-fluid flex-column flex-center">
                        ...
                        <div class="login-form login-signin py-11">
                            ...
                            <div class="login-signin">
                                ...
                                <form class="form text-left" id="kt_login_signin_form" action="{{ route('postEmail') }}" method="post">
                                @csrf
                                <input type="hidden" name="token" value="{{ $token }}">
                                <input type="hidden" name="txtFormID" value="3">
                                    <div class="form-group py-2 m-0">
                                        <input class="form-control h-auto border-1 px-4 placeholder-dark-75" type="text" placeholder="Enter Password" name="password" autocomplete="off" />
                                        
                                    </div>
                                    <div class="form-group py-2 m-0">
                                        <input class="form-control h-auto border-1 px-4 placeholder-dark-75" type="text" placeholder="Enter ConfirmPassword" name="password_confirmation" autocomplete="off" />
                                    ...
                                    <div class="text-center mt-15">
                                        <button id="kt_login_signin_submit" class="btn btn-primary btn-pill shadow-sm py-4 px-9 font-weight-bold">Submit Now</button>
                                    </div>
                                </form>
                            </div>
                            <!--end:Sign In Form-->
