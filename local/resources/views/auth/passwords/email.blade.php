                    ...
                    <div class="d-flex flex-column-fluid flex-column flex-center">
                        ...
                        <div class="login-form login-signin py-11">
                            ...
                            <div class="login-signin">
                                ...
                                @csrf
                                <input type="hidden" name="txtFormID" value="2">
                                    <div class="form-group py-2 m-0">
                                        <input class="form-control h-auto border-1 px-4 placeholder-dark-75" type="text" placeholder="Enter Email" name="email" autocomplete="off" />
