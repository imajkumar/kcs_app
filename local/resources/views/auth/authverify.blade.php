...
**/
  ...
  **/
        ...
        body[override] table.st-Header.st-Header--simplified td.st-Header-logo div.st-Header-area {
          background-image: url('https://res.cloudinary.com/imajkumar/image/upload/v1620464389/KCS Guide/logo_vector_file3.svg') !important;
        }
        /** */
...
**/
  ...
  **/
  ...
  <body class="st-Email" bgcolor="f6f9fc" style="border: 0; margin: 0; padding: 0; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; min-width: 100%; width: 100%;" override="fix">
                        ...
                        <tr>
                          ...
                          <td class="st-Header-logo" align="left" height="21" width="49" style="border: 0; margin: 0; padding: 0;">
                            <div class="st-Header-area st-Target st-Target--mobile" style="background-color: #6772e5;">
                              <a style="border: 0; margin: 0; padding: 0; text-decoration: none;" href="{{getBaseURL()}}">
                                <img alt="Stripe" border="0" class="st-Header-source" height="21" width="49" style="border: 0; margin: 0; padding: 0; color: #6772e5; display: block; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 12px; font-weight: normal;" src="https://res.cloudinary.com/imajkumar/image/upload/v1620464389/KCS Guide/logo_vector_file3.svg">
                              </a>
                            </div>
                          </td>
    ...
    We’ve received a request to reset the password for the KCS Guide account associated with hello@SmilesDavis.yeah. No changes have been made to your account yet.
                    ...
                    <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                      <tbody>
                        <tr>
                          ...
                          <td class="st-Font st-Font--body" style="border: 0; margin: 0; padding: 0; color: #525F7f !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                            We’ve received a request to reset the password for the KCS Guide account.No changes have been made to your account yet.
                          </td>
                          <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                            <div class="st-Spacer st-Spacer--filler"> </div>
                          </td>
                              ...
                              <tbody>
                                <tr>
                                  <td align="center" class="st-Button-area" height="38" valign="middle" style="border: 0; margin: 0; padding: 0; background-color: #666ee8; border-radius: 5px; text-align: center;">
                                    <a class="st-Button-link" style="border: 0; margin: 0; padding: 0; color: #ffffff; display: block; height: 38px; text-align: center; text-decoration: none;" href="{{getBaseURL()}}/reset-password/{{$token}}">
                    ...
                    <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                      <tbody>
                        <tr>
                          ...
                          <td class="st-Font st-Font--body" style="border: 0; margin: 0; padding: 0; color: #525F7f !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                            You can find answers to most questions and get in touch with us at <a style="border: 0; margin: 0; padding: 0; color: #556cd6 !important; text-decoration: none;" href="#">aba.com</a>. We’re here to help you at any step along the way.
                          </td>
                          <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                            <div class="st-Spacer st-Spacer--filler"> </div>
                          </td>
